...
void SendMessage()
{
  ...
  SIM900.println("AT+CMGS=\"+916264588541\"\r"); // Replace x with mobile number
  delay(1000);
...
void MakeCall()
{
  SIM900.println("ATD+916264588541;"); // ATDxxxxxxxxxx; -- watch out here for semicolon at the end, replace your number here!!
